 ...
 * A01712387
 * Esta clase define el objetos de tipo Usuario para registrarlos y solicitar materiales.
 */
...
class Usuarios{
    ...
    public:
        ...
        /*
        solicitar_material se encarga de mandar a llamar a la funcion prestar de la clase material
        para hacer entrega del material e imprime un mensaje dependiendo de la disponibilidad del material
        */
